...
namespace Orange.Library.Values
{
   ...
   {
      protected static ParameterBlock defaultIf()
      {
      ...
      public CFor CFor(ParameterBlock incrementBlock) => new(seed, next, incrementBlock);
      ...
      public virtual Value Map() => new Sequence(this) { Arguments = Arguments.Clone() }.Map();

      public virtual Value IfMessage() => new Sequence(this) { Arguments = Arguments.Clone() }.If();

      public virtual Value Unless() => new Sequence(this) { Arguments = Arguments.Clone() }.Unless();

      public virtual Value Take() => new Sequence(this) { Arguments = Arguments.Clone() }.Take();
