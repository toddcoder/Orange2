...
namespace Orange.Library.Values
{
	public class Sequence : Value, ISequenceSource
	{
		public abstract class Item
		{
			...
			public abstract SignalType Signal
			{
				get;
			}
		...
		public class MapItem : Item
		{
			...
			public MapItem(ParameterBlock parameterBlock)
			{
		...
		public class IfItem : Item
		{
			...
			public IfItem(ParameterBlock parameterBlock)
			{
				this.parameterBlock = parameterBlock;
			}
		...
		public class UnlessItem : Item
		{
			...
			public UnlessItem(ParameterBlock parameterBlock)
			{
				this.parameterBlock = parameterBlock;
			}
		...
		public class TakeBlockItem : Item
		{
			...
			public TakeBlockItem(ParameterBlock parameterBlock)
			{
				this.parameterBlock = parameterBlock;
			}
	   ...
	   public override string Text
		...
		public override double Number
		{
			get
			{
				return AlternateValue("num").Number;
			}
			set
			{
			}
