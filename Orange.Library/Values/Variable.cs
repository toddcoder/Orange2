...
namespace Orange.Library.Values
{
   ...
   {
      protected const string LOCATION = "Variable";
      ...
      public virtual Value Value
      {
         ...
         set
         {
            value.Must().Not.BeNull().OrThrow(LOCATION, () => $"Value intended for {Name} unknown");
            Regions[Name] = value;
      ...
      public override ValueType Type
      {
         get
         {
            ...
            return Regions.VariableExists(Name) ? Value.Type : ValueType.Nil;
         }
      }
      ...
      public VariableAccessType VariableType { get; set; }
