namespace Orange.Library.Values
{
   ...
   {
      protected const string LOCATION = "Read only array";

      public ReadOnlyArray(Array array) : base(array.Items)
      {
      }

      protected static void throwError() => throw LOCATION.ThrowsWithLocation(() => "Array is read-only");

      public override void Add(Value value) => throwError();
      ...
      public override void AddUnique(Value value) => throwError();
      ...
      public override void Insert(int index, Value value) => throwError();

      public override void Insert(string key, Value value) => throwError();
