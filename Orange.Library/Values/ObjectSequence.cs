...
namespace Orange.Library.Values
{
	public class ObjectSequence : Value, ISequenceSource
	{
		...
		public override ValueType Type
		{
			get
			{
				return ValueType.ObjectSequence;
			}
		}
		...
		{
			return new ObjectSequence((Object)obj.Clone(), region.Clone());
		}
		...
		public Value Reset()
		{
			return MessageManager.MessagingState.SendMessage(obj, "reset", new Arguments());
		}
		...
		public int Limit
		{
			get
			{
				return (int)MessageManager.MessagingState.SendMessage(obj, "limit", new Arguments()).Number;
			}
		}
		...
		public Array Array
		{
			get
			{
				return Array.ArrayFromSequence(this);
			}
		}
	}
}