...
namespace Orange.Library
{
	public class DefaultParameterNames
	{
		...
		{
			PopAtEnd = false;
			if (!firstPush && Runtime.State.DefaultParameterNames.IsUpperLevel)
			{
				DefaultParameterNames upperLevelNames = Runtime.State.DefaultParameterNames;
		...
		public string ValueVariable1
		{
			get;
			set;
		}

		public string ValueVariable2
		{
			get;
			set;
		}
		...
		public string ReaderVariable
		{
			get;
			set;
		}

		public string WriterVariable
		{
			get;
			set;
		}

		public List<string> UnpackedVariables
		{
			get;
			set;
		}
