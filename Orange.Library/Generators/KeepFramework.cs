...
namespace Orange.Library.Generators
{
   public class KeepFramework : GeneratorFramework
   {
      ...
      public KeepFramework(Generator generator, Block block, Arguments arguments) : base(generator, block, arguments)
      {
         trueArray = new Array();
      ...
      public override Value ReturnValue() => new Array { trueArray, falseArray };
   }
}