...
namespace Orange.Library.Patterns
{
   public class BreakXBlockElement : BreakXElement
   {
      ...
      public BreakXBlockElement(Block text, int matchIndex = 0) : base("", matchIndex)
      {
         block = text;
      }

      public BreakXBlockElement() : this(null)
      {
      }

      protected void setText() => text = block.Evaluate().Text;
